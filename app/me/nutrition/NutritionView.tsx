...
const defaultTargetKcal = { min: 2150, max: 2250 };

const fallbackMeals: Meal[] = mealsDemo;
...
export default function NutritionView({
  ...
  const targetKcal = {
    min: targetMin ?? defaultTargetKcal.min,
    max: targetMax ?? defaultTargetKcal.max,
  };
